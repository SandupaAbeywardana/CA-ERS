...
<div class="main">
	<br>
	<br>
	<img src="https://cdn.jotfor.ms/assets/img/thankYou/icons/icon1.png" width="250px" height="auto" alt="Thank You Image"/>
	<br>
	<br>
	<br>
	<h1 style="text-align: center; color: white; font-size: 60px;">Thank You!</h1>
	<p style="text-align: center; color: white; font-size: 20px;">Your submission has been successfully recieved.<br>Please check inbox for confirmation mail.</p>
	<br>
